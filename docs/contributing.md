...
For more details about how this works, check the [GitHub official documentation on forking](https://guides.github.com/activities/forking/).
...
- [Run ScanAPI locally](https://github.com/scanapi/scanapi/blob/main/wiki/Run-ScanAPI-Locally.md) - Compare Codespaces, Dev Container, and manual local setup
...
If you're not familiar with how issues work, you can read this quick guide from GitHub: [https://docs.github.com/en/issues/tracking-your-work-with-issues/learning-about-issues/quickstart](https://docs.github.com/en/issues/tracking-your-work-with-issues/learning-about-issues/quickstart)
...
Once you've picked an issue and are ready to start contributing, follow the guide below. It will walk you through the complete workflow, from making changes to opening your pull request: [First Pull Request](https://github.com/scanapi/scanapi/blob/main/wiki/First-Pull-Request.md)
...
We also recommend exploring the project [Wiki](https://github.com/scanapi/scanapi/blob/main/wiki/README.md), which contains additional guides and resources to help you throughout the contribution process.
