...
class TestTemplateRender:
    class TestRender:
        ...
        def test_should_render_json(self, mocked__request):
            ...
            request.body = b'{"uuid": "76fe526d665a46f2812ec6580dd5b34a", "name": "Tarik", "yearsOfExperience": 2, "languages": ["ruby go"], "newOpportunities": false}'
            assert (
                '{"uuid": "76fe526d665a46f2812ec6580dd5b34a", "name": "Tarik", "yearsOfExperience": 2, "languages": ["ruby go"], "newOpportunities": false}'
                == render_body(request)
            )
        ...
        def test_should_render_plain_text(self, mocked__request):
            ...
            request.body = b"this is a custom plain text message"
            assert "this is a custom plain text message" == render_body(request)
