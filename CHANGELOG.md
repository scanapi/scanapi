...
## [Unreleased]
### Fixed
- Add missing `--insecure` flag in curl command based on request options [#554](https://github.com/scanapi/scanapi/issues/554) / [#555](https://github.com/scanapi/scanapi/pull/555)
